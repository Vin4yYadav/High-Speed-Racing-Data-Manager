-- F1 Racing DBMS Project (MySQL Version)
-- ======================================
-- Schema creation
...
-- ==============================
-- SAMPLE DATA INSERTION (shortened)
-- ==============================
...
(8568, 'Max','Joe','Verstappen','Netherlands','1997-09-30',3,110,2016,55000000,2028);

INSERT INTO player VALUES 
(6234, 'Sergio','Michel','Perez','Mexico','1990-01-26',3,85,2011,14000000,2024);
